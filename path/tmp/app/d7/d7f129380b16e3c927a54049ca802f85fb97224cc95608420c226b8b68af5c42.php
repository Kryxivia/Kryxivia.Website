...
/* inc/macros.twig */
class __TwigTemplate_2a71ebdd76a0ecb559a8536f27c3c289be952db1c8ced793571cb30cbfb9a983 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_Rs($__name__ = null, $__link__ = null, $__icon__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 266
            echo "    <div>
        <a href=\"https://t.me/kryxivia\" title=\"";
            // line 267
            echo twig_escape_filter($this->env, ($context["title"] ?? null), "html", null, true);
...
{% macro Rs(name, link, icon) %}
    ...
    <div>
        <a href=\"https://t.me/kryxivia\" title=\"{{title}}\" target=\"_blank\" rel=\"noopener noreferrer\" title=\"{{name}}\">{{icon|replace({'xmlns:v=\"https://vecta.io/nano\"':'','xmlns=\"http://www.w3.org/2000/svg\"':'','</svg>':'<title>'~title~'</title></svg>'})|raw}}</a>
...
{% endmacro %}", "inc/macros.twig", "E:\\wamp64\\www\\Kryxivia\\Views\\inc\\macros.twig");
    }
}
